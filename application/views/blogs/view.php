               ...
               <div class="panel panel-info bg-none">
                  <div class="panel-body">
                     <ul class="media-list m-auto">
                        ...
                        <li class="media m-2">
                           <div class="media-body">
                              <span class="m-2">
                                 ...
                                 <span class="ml-2">
                                    <h5 class="font-weight-bold"><a href="#"><?php echo ucwords($comment['name']); ?></a></h5>
                                    <p class="date text-primary"><?php echo $comment['created_at']; ?></p>
                                    <p class="subject font-weight-bold">
                                       <?php echo ucfirst($comment['comment_subject']); ?>
                                    </p>
                                    <p class="comment">
                              ...
                              <small class="btn btn-primary reply-btn float-right">reply</small>
                              <div class="hideme mb-2" style="display:none">
                                 ...
                                 <div class="mt-4">
                                    <input type="submit" class="btn-dark btn-sm p-20" value="Comment">
                                 </div>
                                 </form>
                              </div>
                           </div>
                        ...
                        <?php else : ?>
                        <li>
                           <span class="font-weight-bold">No Comments To Display</span>
                        </li>
                        <?php endif; ?>
                     </ul>
                  </div>
...
<script>
   $(".reply-btn").click (function(){
     ...
     $(".hideme").stop().slideUp(500); 
     // Toggle this window open/close
     $(this).next(".hideme").stop().slideToggle(500);
     //hitter test// 
     $(".hitter").show()
   });
