...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2020 at 06:35 AM
...
(1, '', 'Accounting', 'account.png', '2020-05-29 07:26:35', '2020-05-29 07:26:35'),
(2, '', 'Development', 'Devlopment.png', '2020-05-29 07:26:59', '2020-05-29 07:26:59'),
(3, '', 'Technology', 'Technology.png', '2020-05-29 07:27:29', '2020-05-29 07:27:29'),
(5, '', 'Medical', 'medical.png', '2020-05-29 07:28:11', '2020-05-29 07:28:11'),
(6, '', 'Goverment', 'goverment.png', '2020-05-29 07:28:34', '2020-05-29 07:28:34'),
(7, '', 'Media & News', 'media-news.png', '2020-05-29 08:01:49', '2020-05-29 08:01:49');
...
CREATE TABLE `comments` (
  ...
  `comment_user_logo` varchar(255) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(6, '', 1, 'hello', 'hello@gmail.com', 'Blog title', 'So why do you need to add photos to your blog posts when your words should be enough to entice your audience, engage visitors, and persuade people that your content is great? The truth is, it’s not enough. Especially when writing a blog post for the web.', NULL, '2020-06-01 09:11:17', '2020-06-01 09:11:17'),
(7, '', 1, 'hello mishra', 'mishra.hello@gmail.com', 'Blog post 1', 'So why do you need to add photos to your blog posts when your words should be enough to entice your audience, engage visitors, and persuade people that your content is great? The truth is, it’s not enough. Especially when writing a blog post for the web.', NULL, '2020-06-01 09:12:34', '2020-06-01 09:12:34');
...
(1, 'saurabh', 'sona.vipin@gmail.com', 'hello', 'hello text', '2020-06-05 04:32:23', '2020-06-05 04:32:23'),
(2, 'hello', 'hello@gmail.com', 'hello12', 'text pre message', '2020-06-05 04:34:56', '2020-06-05 04:34:56');
...
(3, '5ed4751cf38ec', 'Master/Post-graducation', 'CS', 'Others', 'Kuman University', 'Part Time', 2000, 'PHP,React', '1', '2020-06-01 03:31:17', '2020-06-01 03:31:17');
...
(1, '', 'Technical Support', 'Quick company', 'QuickCompany search bar and MCA21 master data are the most commonly used platform for free company search. \r\nHere is opening many vacancies there apply here .', 'Full time', 'Technology', 'Noida', '10k', '50k', 'pru.png', '2020-05-28 04:46:18', '2020-05-29 10:35:42'),
(2, '', 'customer services', 'Kp capital', 'K.P. Energy Limited is an India-based company engaged in the business of windmill infrastructure development. The Company provides a range of solutions from concept till completion of the project life-cycle of a wind project.', 'Full time', 'Technical', 'Delhi , sector 32 pritampura', '25k', '35k', 'kpc.png', '2020-05-29 09:24:26', '2020-05-29 09:59:41'),
(3, '', 'Customer Services', 'TVS company', 'The company has an annual sales of 3 million units and an annual capacity of over 4 million vehicles. TVS Motor Company is also the 2nd largest exporter in India with exports to over 60 Countries.', 'Part time', 'Technology', 'Kanpur , Jarib chowki Up', '10k', '20k', 'tvs.png', '2020-05-29 09:27:38', '2020-05-29 10:00:03'),
(4, '', 'Articulate', 'Articulate Company', 'Articulate is renowned for building the best e-learning authoring software around. Learn more about the company values, executive team, career opportunities.', 'WFH (correspondence)', 'Development', 'Greater noida , pari chowk ', '15k', '45k', 'articulate.png', '2020-05-29 10:17:45', '2020-05-29 10:17:45'),
(5, '', 'Customer dealer', 'Best car company', 'Best Car Brands in India that includes ... Right now, ahead of the advent of BS VI emission norms, the company is the same state.', 'Full time', 'Accounting', 'Noida sector 62', '20k', '55k', 'bestcar.png', '2020-05-29 10:21:18', '2020-05-29 10:21:18'),
(6, '', 'Airtel customer services', 'Airtel company', 'Bharti Airtel Limited, also known as Airtel, is an Indian global telecommunications services company.', 'Part time', 'Technology', 'Gurugram', '12.5 k', '17.5k', 'airtel.png', '2020-05-29 10:23:58', '2020-05-29 10:23:58'),
(7, '', 'Burger King Delivery boy', 'Burger King company', ' The two initiated a corporate restructuring of the chain; the first step being to rename the company Burger King.', 'Part time', 'Delivery boy', 'Noida', '8k', '10k', 'burger-king.png', '2020-05-29 10:28:33', '2020-05-29 10:28:33'),
(8, '', 'Technical supplair', 'Godaddy Technical Support ', 'GoDaddy Inc. is a technology provider to small businesses, Web design professionals and individuals. The Company delivers cloud-based products and personalized customer care. ... It provides Website building, hosting and security tools to help customers construct and protect online presence.', 'Correspondence', 'Technical', 'Noida', '10k', '100k', 'godaddy.png', '2020-05-29 10:31:54', '2020-05-29 10:31:54');
...
(3, '5ed4751cf38ec', '<p>ApanaJob.com with MCA in Computers currently in Noida with prudigital media exp on 4 year...</p>\r\n', 'Delhi,Unnao', 'Temporary/Contract', 'Part Time', 'php', '3.1', 2000, 2000, 'Male', '1', '2020-06-01 03:31:47', '2020-06-01 03:31:47');
...
(1, '5eccba98b956e', 'saurabh', 'saurabh@gmail.com', '25d55ad283aa400af464c76d713c07ad', '7838094755', 'Hariyana', 'Php Course Ducat.pdf', '1', '2020-05-26 06:43:36', '2020-05-26 06:43:36'),
(2, '5ed13458ddbaf', 'saurabh2411', 'saurabh2411@gmail.com', '25d55ad283aa400af464c76d713c07ad', '9876543219', 'Delhi', 'Php Course Ducat.pdf', '1', '2020-05-29 16:12:08', '2020-05-29 16:12:08'),
(3, '5ed4751cf38ec', 'vivek', 'vivek@gmail.com', '25d55ad283aa400af464c76d713c07ad', '9876543200', 'Kanpur', 'db.txt', '1', '2020-06-01 03:25:16', '2020-06-01 03:25:16');
...
CREATE TABLE `replies` (
  ...
  `reply_uid` varchar(15) NOT NULL,
  `comment_id` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `email` varchar(100) NOT NULL,
  `reply_body` text NOT NULL,
  `reply_user_logo` varchar(255) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
